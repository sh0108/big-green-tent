...
function formatOrg(row) {
  ...
  return {
    ...
    rawMetrics: {
      ...
      daysCashOnHand: row.daysCashOnHand,
      monthsUnrestricted: row.monthsUnrestricted,
      currentRatio: row.currentRatio,
      surplusDeficit3yr: row.surplusDeficit3yr,
      revenueTrend: row.revenueTrend,
      revConcentrationPct: row.revConcentrationPct,
      earnedIncomePct: row.earnedIncomePct,
      programExpenseRatio: row.programExpenseRatio,
